						...
						<div id="main" class="eightcol first clearfix" role="main">
							...
							<?php if (is_category()) { ?>
								<h1 class="archive-title h2">
									<span><?php _e( 'Posts Categorized:', 'temperancetheme' ); ?></span> <?php single_cat_title(); ?>
								</h1>

							<?php } elseif (is_tag()) { ?>
								<h1 class="archive-title h2">
									<span><?php _e( 'Posts Tagged:', 'temperancetheme' ); ?></span> <?php single_tag_title(); ?>
								</h1>
							...
							?>
								<h1 class="archive-title h2">
									...
									<span><?php _e( 'Posts By:', 'temperancetheme' ); ?></span> <?php the_author_meta('display_name', $author_id); ?>

								</h1>
							<?php } elseif (is_day()) { ?>
								<h1 class="archive-title h2">
									<span><?php _e( 'Daily Archives:', 'temperancetheme' ); ?></span> <?php the_time('l, F j, Y'); ?>
								</h1>

							<?php } elseif (is_month()) { ?>
									<h1 class="archive-title h2">
										<span><?php _e( 'Monthly Archives:', 'temperancetheme' ); ?></span> <?php the_time('F Y'); ?>
									</h1>
